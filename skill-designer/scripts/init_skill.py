...
**Note:** Scripts are executed directly and can be read or patched as needed.

### references/
Documentation and reference material loaded only when needed.
...
**Appropriate for:** In-depth documentation, API references, database schemas, comprehensive guides, or any detailed information needed while working.

### assets/
Files used in the final output rather than loaded as documentation.
...
Asset files are used in the final output rather than loaded as documentation.
