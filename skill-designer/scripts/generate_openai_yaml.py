#!/usr/bin/env python3
"""
UI Metadata Generator - Creates agents/openai.yaml for a skill folder.
...
def read_frontmatter_name(skill_dir):
    ...
    try:
        ...
        print("[ERROR] SKILL.md is not UTF-8 encoded; re-save it as UTF-8 and try again.")
        return None
    match = re.match(r"^---\n(.*?)\n---", content, re.DOTALL)
    if not match:
    ...
    from quick_validate import parse_frontmatter
